...
public class GameObject
{
	...
	*/
	...
	public void yaw(float angle) {
		...
		Matrix4f yawMatrix = new Matrix4f().rotationY(angleRad);
		
		localRotation.mul(yawMatrix);
	...
	public void pitch(float angle) {
		...
		Matrix4f tempMatrix = new Matrix4f(localRotation);
		Matrix4f pitchMatrix = new Matrix4f().rotationX(angleRad);

		tempMatrix.mul(pitchMatrix);
		localRotation.set(tempMatrix);
